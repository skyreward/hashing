...
unsigned int nTargetSpacing = 1 * 70; // 70 secs
...
const string strMessageMagic = "cubehash Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    else if(pindexBest->nHeight < 560)
    {
        nSubsidy = 400 * COIN;
    }
    else if(pindexBest->nHeight < 760)
    {
        nSubsidy = 0 * COIN;
    }
    ...
    else if(pindexBest->nHeight < 1260)
    {
        nSubsidy = 0 * COIN;
    }
    else if(pindexBest->nHeight < 1560)
    {
        nSubsidy = 200 * COIN;
    }
    else if(pindexBest->nHeight < 1770)
    {
        nSubsidy = 0 * COIN;
    }
    ...
    else if(pindexBest->nHeight < 2260)
    {
        nSubsidy = 0 * COIN;
    }
    else if(pindexBest->nHeight < 2560)
    {
        nSubsidy = 50 * COIN;
    }
    else if(pindexBest->nHeight < 2960)
    {
        nSubsidy = 20 * COIN;
    }
...
// cubehash: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "cubehash", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "The new crypto";
        CTransaction txNew;
        txNew.nTime = 1426627577;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x0fe8076826a862aba02bf7a2626af53260b4fe6de2417fbc15e823e441e2b0b0"));
        block.print();
